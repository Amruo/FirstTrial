 ...
 * different operation such as add a node, retrieve a node or deleting the node, also can print form both side 
 * head or tail as double link list. the program consist of 3 classes, first class is for the element list, second
